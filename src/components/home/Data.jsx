...
const Data = () => {
  return (
    <div className="home-data">
      <h1 className="home-title">Trev Brown
      ...
      <p>I'm a Web Developer from Myanmar, and I'm very passionate and dedicated to my work.</p>
      <a href="#contact" className="button button-flex">
        <i className="blah uil uil-message" style={{marginRight: '10px'}}></i> Say Hello
      </a>
    </div>
  )
}
